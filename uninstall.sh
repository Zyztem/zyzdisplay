...
systemctl disable --now zyzdisplay-kiosk.service uxplay.service miracle-watch.service miracle-sink.service miracle-wifid.service go-librespot.service zyzdisplay-dashboard.service zyz-bluetooth.service zyz-disc.service zyz-kiosk-escape.service 2>/dev/null || true
rm -f /etc/systemd/system/zyzdisplay-kiosk.service \
      ...
      /etc/systemd/system/zyz-kiosk-escape.service
...
rm -f /usr/local/libexec/zyz-kiosk \
      ...
      /usr/local/libexec/zyz-kiosk-escape \
